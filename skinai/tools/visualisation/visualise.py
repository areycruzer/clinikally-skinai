...
from skinai.objects import Tool, Error
from skinai.util.skinai_chain_of_thought import SkinAIChainOfThought
from skinai.tools.visualisation.objects import (
    ChartResult,
    BarChart,
    HistogramChart,
    ScatterOrLineChart,
)
from skinai.tools.visualisation.util import convert_chart_types_to_matplotlib
from skinai.tools.visualisation.prompt_templates import (
    CreateBarChart,
    CreateHistogramChart,
    CreateScatterOrLineChart,
)
from skinai.objects import Response
from skinai.util.objects import TrainingUpdate, TreeUpdate
    ...
    async def __call__(
        ...
        **kwargs,
        ...
        try:
            ...
            create_chart = SkinAIChainOfThought(
