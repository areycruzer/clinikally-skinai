...
from skinai.objects import Response, Status, Tool, Error
from skinai.tools.retrieval.objects import Aggregation
...
from skinai.util.objects import TrainingUpdate, FewShotExamples
from skinai.util.parsing import format_aggregation_response
...
class Aggregate(Tool):
    ...
    async def __call__(
        ...
        **kwargs,
        ...
        aggregate_generator = SkinAIChainOfThought(
            aggregation_prompt,
            tree_data=tree_data,
            environment=True,
