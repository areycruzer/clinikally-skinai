...
from skinai.objects import Response, Status, Tool, Error, Result, Return, Retrieval
from skinai.tools.retrieval.chunk import AsyncCollectionChunker
from skinai.tools.retrieval.objects import (
    ConversationRetrieval,
    DocumentRetrieval,
    MessageRetrieval,
)
from skinai.tools.retrieval.prompt_templates import (
    QueryCreatorPrompt,
    construct_query_output_prompt,
)
from skinai.tools.retrieval.util import (
...
from skinai.util.return_types import all_return_types
...
class Query(Tool):
    ...
    async def __call__(
        ...
        **kwargs,
        ...
        query_generator = SkinAIChainOfThought(
