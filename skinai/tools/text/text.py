...
# LLM
from skinai.objects import Response, Tool
from skinai.tools.text.objects import TextWithTitle, TextWithCitations
from skinai.tools.text.prompt_templates import (
    SummarizingPrompt,
    TextResponsePrompt,
...
class CitedSummarizer(Tool):
    ...
    async def __call__(
        ...
        **kwargs,
        ...
        summarizer = SkinAIChainOfThought(
            CitedSummarizingPrompt,
            tree_data=tree_data,
            reasoning=False,
            impossible=False,
