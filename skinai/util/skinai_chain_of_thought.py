...
from skinai.tree.objects import TreeData, Atlas
...
class SkinAIChainOfThought(Module):
    """
    ...
    Example:
    ```python
    my_module = SkinAIChainOfThought(
        signature=...,
        tree_data=...,
        message_update=True,
        environment=True,
    ...
    def __init__(
        ...
        **config,
        ...
        Args:
            ...
            tree_data (TreeData): Required. The tree data from the SkinAI decision tree.
        ...
        self.predict.signature.instructions += skinai_meta_prompt  # type: ignore
