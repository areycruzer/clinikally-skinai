...
from skinai.util.collection import (
...
from skinai.util.return_types import specific_return_types, types_dict, all_return_types
...
async def collection_metadata(
    ...
    This retrieves the output of the `.preprocess` function in SkinAI.
...
async def update_metadata(
    ...
    This updates the output of the `.preprocess` function in SkinAI.
