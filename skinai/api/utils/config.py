...
class Config:
    ...
    def __init__(
        ...
        self.use_skinai_collections: bool = use_skinai_collections
    ...
    def from_json(cls, json: dict):
        ...
        return cls(
            ...
            use_skinai_collections=(
                json["use_skinai_collections"]
                if "use_skinai_collections" in json
                else True
            ),
        )
...
class FrontendConfig:
    ...
    Anything that does not fit into the SkinAI backend/python package, but relevant to the app is here.
    """
