    ...
    try:
        ...
        while True:
            try:
                ...
                # Weaviate gRPC timeouts raise CancelledError (BaseException).
                # Absorb it so the WebSocket connection survives for the next query.
                logger.warning("WebSocket handler caught CancelledError — connection kept alive")
