...
from skinai.tree.util import delete_tree_from_weaviate
from skinai.api.utils.config import Config, BranchInitType
...
class TreeManager:
    ...
    Designed to be used with the SkinAI API, or a manager for multiple SkinAI decision trees.
        ...
        if not self.tree_exists(conversation_id):
            self.trees[conversation_id] = {
                "tree": Tree(
                    ...
                    use_skinai_collections=self.config.use_skinai_collections,
                ),
