...
from skinai.tree.objects import TreeData
from skinai.util.objects import TrainingUpdate, TreeUpdate, FewShotExamples
from skinai.util.skinai_chain_of_thought import SkinAIChainOfThought
from skinai.util.parsing import format_datetime
from skinai.util.client import ClientManager
from skinai.tree.prompt_templates import (
    FollowUpSuggestionsPrompt,
    TitleCreatorPrompt,
    DecisionPrompt,
)
from skinai.tools.text.prompt_templates import TextResponsePrompt
from skinai.util.retrieve_feedback import retrieve_feedback
...
class ForcedTextResponse(Tool):
    ...
    async def __call__(
        ...
        **kwargs,
        ...
        text_response = SkinAIChainOfThought(
            TextResponsePrompt,
            tree_data=tree_data,
            environment=True,
...
class DecisionNode:
    ...
    async def __call__(
        ...
        **kwargs,
        ...
        if not one_choice:
            decision_module = SkinAIChainOfThought(
                DecisionPrompt,
                tree_data=tree_data,
                environment=True,
                collection_schemas=self.use_skinai_collections,
                tasks_completed=True,
                message_update=True,
