...
<!-- https://github.com/weaviate/skinai/blob/main/CONTRIBUTING.md -->
...
- [ ] `requires_env` tests are passing locally (optional - see [Testing guidelines](https://github.com/weaviate/skinai?tab=contributing-ov-file#testing))
