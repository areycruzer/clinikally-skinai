...
def test_query_weaviate():
    ...
    try:
        ...
        from skinai import preprocess

        preprocess("JeopardyQuestion", force=True)

        from skinai import view_preprocessed_collection
        ...
        with client_manager.connect_to_client() as client:
            ...
            from skinai import delete_preprocessed_collection
...
def test_data_analysis():
    ...
    # Box 1: Configure SkinAI
    from skinai import configure
